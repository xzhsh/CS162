...
/**
 * {@link HandshakeWorker} is a runnable that will be utilized by the {@link GameServer}
 ...
 * will deposit open sockets in a queue, and {@link HandshakeWorker} will 
 * dequeue them and attempt to accept the SYN_ID
 * 
 * When the SYN_ID is received, {@ HandshakeWorker} will store the connection if the id
...
public class HandshakeWorker implements Runnable {
	...
	public HandshakeWorker(GameServer server)
	{
		this.server = server;
		done = false;
	}
